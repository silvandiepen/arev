...
import { worldMapCountries } from "./worldMap.js";

const worldMapCountryCodes = new Set(worldMapCountries.map((country) => country.code));
...
function buildTerritory(code: string): TimezoneTerritory {
  ...
  return {
    ...
    mappable: worldMapCountryCodes.has(normalizedCode),
