...
/**
 * Get all countries whose flags share one or more given colours.
 * When an array is provided, flags matching any of the supplied colours are returned.
 */
export function getFlagsByColor(color: FlagInfo["colors"][number]): FlagInfo[];
export function getFlagsByColor(colors: readonly FlagInfo["colors"][number][]): FlagInfo[];
