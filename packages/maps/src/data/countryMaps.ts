 ...
 * @example
 * ```ts
 * import { getCountrySvg } from "/data";
 *
...
import type { CountryMapOptions } from "../../../core/src/types/index.js";
import { getCountryMapData } from "./worldMap.js";
import { getCitiesByCountry, isCapitalCity } from "../../../geo/src/data/cities.js";
import { getCountryGeography } from "../../../geo/src/data/geography.js";
  ...
  if (opts.showCities) {
    ...
    cityMarkersHtml = citiesForCountry
      .map(city => {
        ...
        const isCapital = isCapitalCity(city);
