<template>
  <div class="col" style="gap:1.5rem">
    ...
    <div class="card col">
      ...
      <div class="code">import { getStatesByCountry } from "arevdata";
...
import { states, getStatesByCountry, getStateByCode, getStatesByType, getCountryByCode, getCountryFlag } from "arevdata";
import type { StateType } from "arevdata";
