<template>
  <div class="col" style="gap:1.5rem">
    ...
    <div class="card col">
      ...
      <div class="code">import { highlightCountries } from "arevdata";
...
highlightCountries([
  ...
  { alpha2: "{{ highlightB }}", color: "{{ colorB }}" },
    ...
    <div class="card col">
      ...
      <div class="code">import { colorizeWorldMap } from "arevdata";
...
colorizeWorldMap({
  ...
  "#64b5f6": ["CN","JP","KR"],   // blue group
    ...
    <div class="card col">
      ...
      <div class="code">import { getCountrySvg } from "arevdata";
getCountrySvg("{{ countryCode }}", { fill: "{{ countryFill }}", stroke: "#64b5f6" })</div>
    ...
    <div class="card col">
      ...
      <div class="code">import { getWorldMapSvg, WORLD_MAP_VIEWBOX, WORLD_MAP_DEFAULTS } from "arevdata";
...
getWorldMapSvg({ background: "#1a1d2e", defaultFill: "#2e3350", stroke: "#0f1117" })</div>
    ...
    <div class="card col">
      ...
      <div class="code">import { getCountryMapData, searchWorldMapCountries, worldMapCountries } from "arevdata";
...
searchWorldMapCountries("{{ mapSearch }}").length // → {{ searchWorldMapCountries(mapSearch).length }}</div>
    ...
    <div class="card col">
      ...
      <div class="code">import { getCountryMapSvgUrl, getCountrySubdivisionMapUrl, latLonToMapPoint, COUNTRY_MAP_DEFAULTS } from "arevdata";
