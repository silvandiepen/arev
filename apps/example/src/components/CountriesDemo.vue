<template>
  <div class="col" style="gap:1.5rem">
    ...
    <div class="card col">
      ...
      <div class="code">import { countries, getCountryByCode, getCountriesByContinent, getCountryFlag, getRecognizedCountries } from "@arevs/data";</div>
      <div class="row">
...
// → {{ getRecognizedCountries().length }} UN-recognized countries</div>
    ...
    <div class="card col">
      ...
      <div class="code">import { phoneCountryCodes, getPhoneCodeByCountry, getCountriesByPhoneCode } from "@arevs/data";
...
// → {{ getCountriesByPhoneCode(sharedPhoneCode).length }} countries share this code</div>
    ...
    <div class="card col">
      ...
      <div class="code">import { continents, getContinentByCode } from "@arevs/data";
...
import type { ContinentName } from "@arevs/data";
