<template>
  <div class="col" style="gap:1.5rem">
    ...
    <div class="card col">
      ...
      <div class="code">import { getCountryGeography } from "@arevs/data";
...
// → "{{ direction ?? 'null' }}"</div>
    ...
    <div class="card col">
      ...
      <div class="code">import { haversineDistance, bearing, bearingToCardinal } from "@arevs/data";
...
// → "{{ bearingToCardinal(rawBearing) }}"</div>
    ...
    <div class="card col">
      ...
      <div class="code">import { compareTemperature, compareSize, getHemisphere } from "@arevs/data";
...
import type { ClimateZone } from "@arevs/data";
