<template>
  <div class="col" style="gap:1.5rem">
    ...
    <div class="card col">
      ...
      <div class="code">import { getFlagSvgUrl, getFlagPngUrl } from "@arevs/data";
...
import { flagData, getFlagSvgUrl, getFlagPngUrl, getFlagData, getFlagsByColor, getSimilarFlags } from "@arevs/data";
import type { FlagColor } from "@arevs/data";
