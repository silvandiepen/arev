<template>
  <div class="col" style="gap:1.5rem">
    ...
    <div class="card col">
      ...
      <div class="code">import { getGeoHints } from "@arevs/data";
...
import { countries, getCountryByCode, getGeoHints } from "@arevs/data";
import type { Country, GeoHint } from "@arevs/data";
