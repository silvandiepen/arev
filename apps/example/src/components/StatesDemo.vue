<template>
  <div class="col" style="gap:1.5rem">
    ...
    <div class="card col">
      ...
      <div class="code">import { getStatesByCountry } from "@arevs/data";
...
import { states, getStatesByCountry, getStateByCode, getStatesByType, getCountryByCode, getCountryFlag } from "@arevs/data";
import type { StateType } from "@arevs/data";
