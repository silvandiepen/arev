<template>
  <div class="col" style="gap:1.5rem">
    ...
    <div class="card col">
      ...
      <div class="code">import { getCurrencyByCode } from "@arevs/data";
getCurrencyByCode("{{ isoCode.toUpperCase() }}")</div>
    ...
    <div class="card col">
      ...
      <div class="code">import { currencies } from "@arevs/data";
...
import { currencies, getCurrencyByCode, getCurrencyByCountry } from "@arevs/data";
