...
```ts
import { getWorldMapSvg } from "/data";
...
```ts
import { highlightCountries } from "/data";
...
```ts
import { colorizeWorldMap } from "/data";
...
```ts
import { getCountryMapData } from "/data";
...
```ts
import { searchWorldMapCountries } from "/data";
