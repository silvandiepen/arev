...
```ts
import { getCountryGeography, countryGeography } from "/data";
...
```ts
import { getLandlockedCountries } from "/data";
...
```ts
import { getCountriesByClimate } from "/data";
...
```ts
import { getDistanceBetweenCountries, haversineDistance } from "/data";
...
```ts
import { compareTemperature } from "/data";
...
```ts
import { getHemisphere } from "/data";
...
```ts
import { getGeoHints } from "/data";
import type { GeoHint } from "/data";
...
```ts
import { countries, getGeoHints } from "/data";
...
```ts
import { getGeoHints, getCountryByCode } from "/data";
