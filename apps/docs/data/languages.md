...
```ts
import { canonicalizeLanguageCode } from "/data";
...
```ts
import { getLanguageVariants } from "/data";
...
```ts
import { getLanguagesBySpeakerCount } from "/data";
...
```ts
import { searchLanguages } from "/data";
...
```ts
import { getOfficialLanguagesByCountry } from "/data";
...
```ts
import { getOfficialLanguageCountries } from "/data";
