...
```ts
import { continents, getContinentByCode } from "/data";
import type { Continent, ContinentName } from "/data";
```
...
```ts
import { continents, getCountriesByContinent } from "/data";
...
```ts
import { currencies, getCurrencyByCode, getCurrencyByCountry } from "/data";
...
```ts
import { getCurrencyByCode, getCountryByCode } from "/data";
...
```ts
import { getCurrencyByCountry } from "/data";
