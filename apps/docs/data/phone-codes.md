...
import type { PhoneCountryCode } from "/data";
```
...
```ts
import { phoneCountryCodes } from "/data";
...
```ts
import { getPhoneCodeByCountry } from "/data";
...
```ts
import { getCountriesByPhoneCode } from "/data";
